#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_1k_preempt
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_1k_preempt_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_1k_preempt_%j.err
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_1k_preempt DONE (RUN_ID=${RUN_ID}) ====="
