#!/bin/bash
#SBATCH --job-name=kuhn_3b_async_opplin_ms1000
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_opplin_ms1000_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_opplin_ms1000_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    max_steps=1000 \
    actor_infer.strategy_args.strategy_config.max_loras=21 \
    exp_name=kuhn_3b_lorafix_async_opplin_ms1000 \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,opp_linear,ms1000]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B ASYNC OPPLIN MS1000 DONE (RUN_ID=${RUN_ID}) ====="
