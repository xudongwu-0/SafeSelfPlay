#!/bin/bash
#SBATCH --job-name=kuhn_smoke_always_bet
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_smoke_always_bet_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_smoke_always_bet_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name smoke_kuhn_always_bet \
    seed=${SEED:-42} \
    2>&1

rm -rf $TMPDIR
echo "===== SMOKE CHECK DONE (RUN_ID=${RUN_ID}) ====="
