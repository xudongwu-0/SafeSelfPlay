#!/bin/bash
#SBATCH --job-name=kuhn_4b_fsp
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_fsp_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_fsp_%j.err
...
rm -rf $TMPDIR
echo "===== KUHN 4B FSP DONE (RUN_ID=${RUN_ID}) ====="
