#!/bin/bash
#SBATCH --job-name=kuhn_4b_kl0p1_nocold
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_kl0p1_nocold_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_kl0p1_nocold_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_kl0p1_nocold \
...
rm -rf $TMPDIR
echo "===== KUHN 4B NOCOLD KL0P1 DONE (RUN_ID=${RUN_ID}) ====="
