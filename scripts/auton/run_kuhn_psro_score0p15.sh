#!/bin/bash
#SBATCH --job-name=kuhn_psro_score0p15
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_ev_gs24_score0p15 \
...
rm -rf $TMPDIR
echo "===== PSRO score0p15 DONE (RUN_ID=${RUN_ID}) ====="
