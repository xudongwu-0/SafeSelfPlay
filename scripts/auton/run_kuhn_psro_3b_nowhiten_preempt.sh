#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_nowhiten
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_psro_3b_nowhiten \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_nowhiten DONE (RUN_ID=${RUN_ID}) ====="
