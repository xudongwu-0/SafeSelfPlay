#!/bin/bash
#SBATCH --job-name=kuhn_fsp_oppExp
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_oppExp_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_oppExp_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_fsp_fsp50_klanneal_oppExp \
...
rm -rf $TMPDIR
echo "===== FSP TRAIN DONE (RUN_ID=${RUN_ID}, opp=exponential) ====="
