#!/bin/bash
#SBATCH --job-name=kuhn_psro_debug_0p5b
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_debug_0p5b_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_debug_0p5b_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_debug_0p5b \
...
rm -rf $TMPDIR
echo "===== PSRO debug_0p5b DONE (RUN_ID=${RUN_ID}) ====="
