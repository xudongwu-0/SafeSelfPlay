#!/bin/bash
#SBATCH --job-name=kuhn_psro_payoff_matrix_smoke
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_payoff_matrix_smoke_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_payoff_matrix_smoke_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_payoff_matrix_smoke \
...
rm -rf $TMPDIR
echo "===== PSRO payoff_matrix_smoke DONE (RUN_ID=${RUN_ID}) ====="
