#!/bin/bash
#SBATCH --job-name=kuhn_debug
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_debug_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_debug_%j.err
...
rm -rf $TMPDIR
echo "===== DEBUG RUN DONE (RUN_ID=${RUN_ID}) ====="
