#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_preempt
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_preempt_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_preempt_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_fixSeed_bubbleEval_rst300_blend3 \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_preempt DONE (RUN_ID=${RUN_ID}) ====="
