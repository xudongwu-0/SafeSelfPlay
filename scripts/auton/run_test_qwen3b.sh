#!/bin/bash
#SBATCH --job-name=test_qwen3b
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/test_qwen3b_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/test_qwen3b_%j.err
...
python $ROLL_DIR/scripts/auton/test_qwen3b_response.py
