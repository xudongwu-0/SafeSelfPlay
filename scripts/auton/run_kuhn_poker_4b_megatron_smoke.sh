#!/bin/bash
#SBATCH --job-name=kuhn_4b_mega_smoke
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_mega_smoke_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_mega_smoke_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_megatron_smoke \
    max_steps=10 \
...
rm -rf $TMPDIR
echo "===== KUHN 4B MEGATRON SMOKE DONE (RUN_ID=${RUN_ID}) ====="
