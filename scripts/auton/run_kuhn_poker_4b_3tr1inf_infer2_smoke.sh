#!/bin/bash
#SBATCH --job-name=kuhn_4b_3tr1inf_b2
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_3tr1inf_b2_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_3tr1inf_b2_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_3tr1inf_infer2_smoke \
...
rm -rf $TMPDIR
echo "===== KUHN 4B 3TR1INF BSZ2 SMOKE DONE (RUN_ID=${RUN_ID}) ====="
