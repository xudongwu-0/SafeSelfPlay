#!/bin/bash
#SBATCH --job-name=kuhn_fsp_blend7_gs24
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend7_gs24_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend7_gs24_%j.err
