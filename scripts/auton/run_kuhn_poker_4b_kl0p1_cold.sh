#!/bin/bash
#SBATCH --job-name=kuhn_4b_kl0p1_cold
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_kl0p1_cold_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_kl0p1_cold_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_kl0p1_cold \
...
rm -rf $TMPDIR
echo "===== KUHN 4B COLD KL0P1 DONE (RUN_ID=${RUN_ID}) ====="
