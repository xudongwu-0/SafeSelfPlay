#!/bin/bash
#SBATCH --job-name=kuhn_fsp_blend7_gs24_preempt
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend7_gs24_preempt_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend7_gs24_preempt_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    +reward_normalization.blended_baseline_c=7.0 \
    exp_name=kuhn_fsp_blend7_gs24 \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,blend_baseline,gs24]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN FSP BLEND7 GS24 DONE (RUN_ID=${RUN_ID}) ====="
