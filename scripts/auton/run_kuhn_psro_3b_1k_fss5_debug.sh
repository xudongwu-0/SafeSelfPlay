#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fss5_dbg
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fss5_dbg_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fss5_dbg_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_1k_fss5_debug \
    max_steps=50 \
    fsp_save_steps=5 \
    'actor_infer.strategy_args.strategy_config.max_loras=11' \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fss5_dbg DONE (RUN_ID=${RUN_ID}) ====="
