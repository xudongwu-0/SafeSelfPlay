#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_reason0p1
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_reason0p1_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_reason0p1_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_reason0p1 \
    2>&1

rm -rf $TMPDIR
echo "===== kuhn_psro_3b_reason0p1 DONE (RUN_ID=${RUN_ID}) ====="
