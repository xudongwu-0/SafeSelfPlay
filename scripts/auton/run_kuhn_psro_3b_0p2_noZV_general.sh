#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_0p2_noZV_preempt
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_0p2_noZV_preempt_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_0p2_noZV_preempt_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_0p2_noZV \
    fsp_score_threshold=0.2 \
    2>&1

rm -rf $TMPDIR
echo "===== kuhn_psro_3b_0p2_noZV_preempt DONE (RUN_ID=${RUN_ID}) ====="
