#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fixSeed
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_fixSeed \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fixSeed DONE (RUN_ID=${RUN_ID}) ====="
