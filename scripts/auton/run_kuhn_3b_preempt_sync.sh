#!/bin/bash
#SBATCH --job-name=kuhn_3b_pr_sync
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_pr_sync_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_pr_sync_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_3b_acttag_fix_sync \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,sync,auton,preempt]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B PREEMPT SYNC DONE (RUN_ID=${RUN_ID}) ====="
