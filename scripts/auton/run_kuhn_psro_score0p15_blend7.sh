#!/bin/bash
#SBATCH --job-name=kuhn_psro_score0p15_blend7
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_blend7_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_blend7_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_ev_gs24_score0p15_blend7 \
...
rm -rf $TMPDIR
echo "===== PSRO score0p15_blend7 DONE (RUN_ID=${RUN_ID}) ====="
