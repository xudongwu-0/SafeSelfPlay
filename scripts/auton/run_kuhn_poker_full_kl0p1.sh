#!/bin/bash
#SBATCH --job-name=kuhn_fsp_kl0p1
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_kl0p1_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_kl0p1_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    kl_loss_coef=0.1 \
    exp_name=kuhn_fsp_5lora_klloss0p1_ga16_gs8_coldstart \
...
rm -rf $TMPDIR
echo "===== FSP TRAIN DONE (RUN_ID=${RUN_ID}, kl_loss_coef=0.1) ====="
