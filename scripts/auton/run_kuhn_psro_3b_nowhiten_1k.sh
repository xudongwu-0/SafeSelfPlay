#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_nowhiten_1k
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_1k_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_1k_%j.err
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_nowhiten_1k DONE (RUN_ID=${RUN_ID}) ====="
