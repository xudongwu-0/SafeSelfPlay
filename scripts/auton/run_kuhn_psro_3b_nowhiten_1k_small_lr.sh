#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_nowhiten_1k_small_lr
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_1k_small_lr_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_nowhiten_1k_small_lr_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_nowhiten_1k_small_lr \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_nowhiten_1k_small_lr DONE (RUN_ID=${RUN_ID}) ====="
