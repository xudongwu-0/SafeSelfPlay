#!/bin/bash
#SBATCH --job-name=kuhn_4b_smoke
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_smoke_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_smoke_%j.err
...
rm -rf $TMPDIR
echo "===== KUHN 4B SMOKE DONE (RUN_ID=${RUN_ID}) ====="
