#!/bin/bash
#SBATCH --job-name=kuhn_psro_gs12_score0p15_mb1
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_gs12_score0p15_mb1_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_gs12_score0p15_mb1_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_ev_gs12_score0p15_mb1 \
    fsp_score_threshold=0.15 \
    rollout_batch_size=132 \
    train_env_manager.group_size=12 \
...
rm -rf $TMPDIR
echo "===== PSRO gs12_score0p15_mb1 DONE (RUN_ID=${RUN_ID}) ====="
