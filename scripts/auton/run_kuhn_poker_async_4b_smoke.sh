#!/bin/bash
#SBATCH --job-name=kuhn_fsp_async_4b_smoke
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_async_4b_smoke_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_async_4b_smoke_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_async_4b_smoke \
...
rm -rf $TMPDIR
echo "===== FSP ASYNC 4B SMOKE DONE (RUN_ID=${RUN_ID}) ====="
