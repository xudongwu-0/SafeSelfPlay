#!/bin/bash
#SBATCH --job-name=kuhn_4b_cold_async
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_cold_async_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_cold_async_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_kl0p01_cold_async \
...
rm -rf $TMPDIR
echo "===== KUHN 4B COLD ASYNC KL0P01 DONE (RUN_ID=${RUN_ID}) ====="
