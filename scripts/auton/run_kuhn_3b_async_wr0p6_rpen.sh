#!/bin/bash
#SBATCH --job-name=kuhn_3b_async_wr0p6_rpen
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_wr0p6_rpen_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_wr0p6_rpen_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,wr0p6,reasoning_penalty]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B ASYNC WR0P6 RPEN DONE (RUN_ID=${RUN_ID}) ====="
