#!/bin/bash
#SBATCH --job-name=kuhn_3b_newprompt_async
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_newprompt_async_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_newprompt_async_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_3b_newprompt_async \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,newprompt]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B NEWPROMPT ASYNC DONE (RUN_ID=${RUN_ID}) ====="
