#!/bin/bash
#SBATCH --job-name=kuhn_4b_ds_smoke
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_ds_smoke_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_ds_smoke_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_fsp_4b_ds_smoke_ibs4 \
    max_steps=10 \
...
rm -rf $TMPDIR
echo "===== KUHN 4B DEEPSPEED SMOKE DONE (RUN_ID=${RUN_ID}) ====="
