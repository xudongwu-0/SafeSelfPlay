#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_wbaseline
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_wbaseline_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_wbaseline_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_fixSeed_bubbleEval_rst300_wbaseline \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_wbaseline DONE (RUN_ID=${RUN_ID}) ====="
