#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_%j.err
...
rm -rf $TMPDIR
echo "===== PSRO 3B DONE (RUN_ID=${RUN_ID}) ====="
