#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_general
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_general_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_general_%j.err
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_general DONE (RUN_ID=${RUN_ID}) ====="
