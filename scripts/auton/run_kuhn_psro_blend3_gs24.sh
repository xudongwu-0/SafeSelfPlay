#!/bin/bash
#SBATCH --job-name=kuhn_psro_blend3_gs24
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_blend3_gs24_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_blend3_gs24_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_blend3_gs24 \
    tracker_kwargs.tags="[kuhn_poker,psro,qwen2_5_3b,cold_start,async,auton,blend_baseline,gs24,blend3]" \
    2>&1

rm -rf $TMPDIR
echo "===== PSRO BLEND3 GS24 DONE (RUN_ID=${RUN_ID}) ====="
