#!/bin/bash
#SBATCH --job-name=kuhn_psro_score0p10
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p10_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p10_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_ev_gs24_score0p10 \
    fsp_score_threshold=0.1 \
...
rm -rf $TMPDIR
echo "===== PSRO score0p10 DONE (RUN_ID=${RUN_ID}) ====="
