#!/bin/bash
#SBATCH --job-name=kuhn_4b_ds_smoke_pre
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_ds_smoke_pre_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_ds_smoke_pre_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_smoke \
    exp_name=kuhn_fsp_4b_ds_smoke_ibs4_preempt \
    max_steps=10 \
...
rm -rf $TMPDIR
echo "===== KUHN 4B DEEPSPEED SMOKE PREEMPT DONE (RUN_ID=${RUN_ID}) ====="
