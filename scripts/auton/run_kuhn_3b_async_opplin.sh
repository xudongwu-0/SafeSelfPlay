#!/bin/bash
#SBATCH --job-name=kuhn_3b_async_opplin
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_opplin_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_async_opplin_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_3b_lorafix_async_opplin \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,opp_linear]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B ASYNC OPPLIN DONE (RUN_ID=${RUN_ID}) ====="
