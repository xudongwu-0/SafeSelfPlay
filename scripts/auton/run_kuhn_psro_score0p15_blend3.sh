#!/bin/bash
#SBATCH --job-name=kuhn_psro_score0p15_blend3
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_blend3_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_score0p15_blend3_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_ev_gs24_score0p15_blend3 \
...
rm -rf $TMPDIR
echo "===== PSRO score0p15_blend3 DONE (RUN_ID=${RUN_ID}) ====="
