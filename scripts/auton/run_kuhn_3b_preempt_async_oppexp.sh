#!/bin/bash
#SBATCH --job-name=kuhn_3b_pr_async_oppexp
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_pr_async_oppexp_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_3b_pr_async_oppexp_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_3b_lorafix_async_oppexp \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,preempt,opp_exponential]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN 3B PREEMPT ASYNC OPPEXP DONE (RUN_ID=${RUN_ID}) ====="
