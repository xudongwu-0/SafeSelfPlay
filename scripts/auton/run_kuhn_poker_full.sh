#!/bin/bash
#SBATCH --job-name=kuhn_fsp
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_%j.err
...
# Shell-level safety net: wipe model-weight dirs on exit (preserves logs/tensorboard/wandb)
...
rm -rf $TMPDIR
echo "===== FSP TRAIN DONE (RUN_ID=${RUN_ID}) ====="
