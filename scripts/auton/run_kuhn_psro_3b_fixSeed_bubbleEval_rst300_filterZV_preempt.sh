#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fixSeed_bubbleEval_rst300_filterZV_preempt
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_filterZV_preempt_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_filterZV_preempt_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_psro_3b_filterZV \
    filter_zero_variance_groups=true \
    2>&1

rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fixSeed_bubbleEval_rst300_filterZV_preempt DONE (RUN_ID=${RUN_ID}) ====="
