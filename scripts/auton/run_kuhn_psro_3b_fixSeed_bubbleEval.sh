#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fixSeed_bubbleEval
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_fixSeed_bubbleEval \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fixSeed_bubbleEval DONE (RUN_ID=${RUN_ID}) ====="
