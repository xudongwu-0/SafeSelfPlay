#!/bin/bash
#SBATCH --job-name=kuhn_4b_sync_infer16
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_sync_infer16_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_sync_infer16_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_fsp_4b_sync_largeinfer_smoke \
...
rm -rf $TMPDIR
echo "===== KUHN 4B SYNC INFER16 SMOKE DONE (RUN_ID=${RUN_ID}) ====="
