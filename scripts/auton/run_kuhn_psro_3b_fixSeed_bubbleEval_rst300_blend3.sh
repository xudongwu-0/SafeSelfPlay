#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3_%j.err
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_fixSeed_bubbleEval_rst300_blend3 DONE (RUN_ID=${RUN_ID}) ====="
