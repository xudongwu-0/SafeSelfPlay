#!/bin/bash
#SBATCH --job-name=kuhn_psro_3b_1k_fixLR_nobubble
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_1k_fixLR_nobubble_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_psro_3b_1k_fixLR_nobubble_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    --config_name agent_kuhn_poker_psro_3b_1k_fixLR_nobubble \
...
rm -rf $TMPDIR
echo "===== kuhn_psro_3b_1k_fixLR_nobubble DONE (RUN_ID=${RUN_ID}) ====="
