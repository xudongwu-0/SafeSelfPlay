#!/bin/bash
#SBATCH --job-name=kuhn_4b_cold_sync
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_cold_sync_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_4b_cold_sync_%j.err
...
rm -rf $TMPDIR
echo "===== KUHN 4B COLD SYNC KL0P01 DONE (RUN_ID=${RUN_ID}) ====="
