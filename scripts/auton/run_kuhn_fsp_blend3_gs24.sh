#!/bin/bash
#SBATCH --job-name=kuhn_fsp_blend3_gs24
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend3_gs24_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_blend3_gs24_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    +reward_normalization.blended_baseline_c=3.0 \
    exp_name=kuhn_fsp_blend3_gs24 \
    tracker_kwargs.tags="[kuhn_poker,fsp_train,qwen2_5_3b,cold_start,async,auton,blend_baseline,gs24,c3]" \
    2>&1

rm -rf $TMPDIR
echo "===== KUHN FSP BLEND3 GS24 DONE (RUN_ID=${RUN_ID}) ====="
