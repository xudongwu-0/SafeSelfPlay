#!/bin/bash
#SBATCH --job-name=kuhn_fsp_oppLin
#SBATCH --output=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_oppLin_%j.out
#SBATCH --error=/zfsauton/scratch/wentsec/ROLL/logs/kuhn_fsp_oppLin_%j.err
...
python examples/start_agentic_pipeline.py \
    ...
    exp_name=kuhn_fsp_fsp50_klanneal_oppLin \
...
rm -rf $TMPDIR
echo "===== FSP TRAIN DONE (RUN_ID=${RUN_ID}, opp=linear) ====="
