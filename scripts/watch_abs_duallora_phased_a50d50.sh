...
TRAIN_CALL_ID="fc-01KZ5CJVJS671FPRG2QKBXKX2V"
RUN_NAME="abs_qwen25_3b_duallora_r32_phased_A50_D50_s100_rb128_tb32_mb8_aLR2e-6_dLR3e-6_kl0p3_rolesft_ourprompts_20260804_112025_spawn"
VOLUME="roll-abs-benchmark-output"
LOCAL_ROOT="/home/xudong/work/self_play/checkpoints/abs_duallora_phased_a50d50_20260804"
EVAL_SLUG="qwen25_3b_duallora_phased_a50d50_20260804"
...
mkdir -p "$LOCAL_ROOT"
echo "[$(date --iso-8601=seconds)] Waiting for phased training $TRAIN_CALL_ID"
...
for step in 50 100; do
    ...
    modal volume get --force "$VOLUME" \
        ...
        "$LOCAL_ROOT/global_step${step}_hf"
done
...
call = function.spawn(
    ...
    model_label="Our phased dual-LoRA A50-D50 (Qwen2.5-3B)",
)
